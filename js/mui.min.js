...
$.fn.serializeObject=function(callback){"use strict";var result={},_this=this;$.each(_this.serializeArray(),function(i,elem){formatObject(elem.name,elem.value,result,getType(_this[0].elements[elem.name]));});callback&&callback(result);return result;};})(jQuery);
