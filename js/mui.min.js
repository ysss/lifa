...
$.extend(Date.prototype, {
     ...
     */
    format: function(formation) {
        var year = this.getFullYear(),
            month = this.getMonth() + 1,
            date = this.getDate(),
            hour = this.getHours(),
            lhour = hour > 12 ? hour - 12 : hour,
            minute = this.getMinutes(),
            second = this.getSeconds(),
            toTwoDigit = function(num){ return num < 10 ? "0" + num : num; },
            formatObj = {
                yyyy: year,
                ...
                hh: toTwoDigit(lhour),
                h: lhour,
                mm: toTwoDigit(minute),
                m: minute,
                ss: toTwoDigit(second),
                s: second
            };
        return formation.replace(/y+|m+|d+|h+|s+|H+|M+/g, function($0) {
            return formatObj[$0] || $0;
        });
    },

    /**
     * 转换成日期格式，例如：2014-05-12
     */
    toDate: function() {
    ...
    /**
     * 转换成日期+时间格式，例如：2014-05-12 12:00:00
     */
    toDateTime: function() {
...
//	p.innerHTML = JSON.stringify('Error: ' + arguments);
...
var T = {
	...
	DOMAIN: 'http://chengse.duapp.com',
//	DOMAIN: 'http://lifa.chengsekongjian.com',
//	DOMAIN: 'http://192.168.1.210:18080',
	...
	getParam: function(key) {
		var val = location.search.match(new RegExp('[\\?&]' + key + '=([^&]*)'));
    ...
    getData: function(url, config) {
        ...
        T.log(config.type + ' ' + url, config.data);
...
(function(T) {
	...
	T.Events = Events();
	T.inherit = function(fn, sup) {
		fn.prototype = sup();
		fn.prototype.constructor = sup;
	};
